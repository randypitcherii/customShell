...
{
       0,     0,     3,     5,     7,     9,    12,    14,    19,    23,
      27,    32,    35,    38,    41,    42,    44,    46,    49,    50,
      53,    56,    59,    62,    65,    67
};
...
{
      14,     0,    -1,    15,    -1,     6,    -1,    16,    -1,    15,
      16,    -1,    17,    -1,    18,    22,    24,     6,    -1,    18,
       7,    18,    -1,    17,     7,    18,    -1,    17,    22,    24,
       6,    -1,     1,     6,    -1,    21,    19,    -1,    19,    20,
      -1,    -1,     3,    -1,     3,    -1,    22,    23,    -1,    -1,
      10,     3,    -1,     5,     3,    -1,    11,     3,    -1,     9,
       3,    -1,     8,     3,    -1,    12,    -1,    -1
};
...
{
       0,    45,    45,    46,    50,    51,    54,    58,    62,    65,
      68,    72,    78,    85,    86,    90,    97,   105,   106,   110,
     118,   125,   134,   142,   152,   155
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE", "LESS", "GREATAMPERSAND", "GREATGREAT", "GREATGREATAMPERSAND",
  "AMPERSAND", "$accept", "start", "commands", "command", "simple_command",
  "command_and_args", "argument_list", "argument", "command_word",
  "io_modifier_list", "io_modifier", "background_optional", YY_NULL
};
#endif
...
{
       0,     0,    16,     3,     0,     0,     4,    18,    18,    14,
      11,     1,     5,     0,    25,     0,    25,    12,     9,     0,
       0,     0,     0,     0,    24,    17,     0,     8,     0,    15,
      13,    20,    23,    22,    19,    21,    10,     7
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     6,     7,     8,    17,    30,     9,    14,
      25,    26
};
...
{
      11,    -4,    -6,    -6,     1,    18,    -6,     8,     3,    -6,
      -6,    -6,    -6,    10,    -5,    10,    -5,    13,    -6,    20,
      21,    22,    23,    24,    -6,    -6,    25,    -6,    26,    -6,
      -6,    -6,    -6,    -6,    -6,    -6,    -6,    -6
};
...
{
      19,    11,    10,    20,    21,    22,    23,    24,    -6,    -6,
      15,    -6,     1,     2,     2,    13,    29,     3,    -2,     1,
      18,     2,    27,    31,    32,    33,    34,    35,    28,     0,
       0,    36,    37,    12,     0,    16
};
...
{
       5,     0,     6,     8,     9,    10,    11,    12,     0,     1,
       7,     3,     1,     3,     3,     7,     3,     6,     0,     1,
      13,     3,    15,     3,     3,     3,     3,     3,    16,    -1,
      -1,     6,     6,     5,    -1,     8
};
...
static const yytype_uint8 yystos[] =
{
       ...
       6,     0,    16,     7,    22,     7,    22,    19,    18,     5,
       8,     9,    10,    11,    12,    23,    24,    18,    24,     3,
      20,     3,     3,     3,     3,     3,     6,     6
};
...
#line 97 "shell.y"
    {
		...
		Command::_currentSimpleCommand->insertArgument(strdup((yyvsp[(1) - (1)].string_val)));
	}
    break;
...
#line 142 "shell.y"
    {
		...
		Command::_currentCommand._inFile = strdup((yyvsp[(2) - (2)].string_val));
	}
    break;
